...
class FireflyAdaptive:
    ...
    def __init__(self, T, A, t):
        ...
        self.R_colors_up = np.linspace(0, 76, round(.3/t)+1)
        self.R_colors_down = np.linspace(0, 76, round(.4/t)+1)
        self.G_colors_up = np.linspace(0, 114, round(.3/t)+1)
        self.G_colors_down = np.linspace(0, 114, round(.4/t)+1)
        self.B_colors_up = np.linspace(0, 29, round(.3/t)+1)
        self.B_colors_down = np.linspace(0, 29, round(.4/t)+1)
        self.t = t
